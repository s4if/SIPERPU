...
//    print_r($temperature);
//    }
echo (isset($_POST['file']))? $_POST['file']:"";
?>
    <form role="form" method="post" action="http://localhost/SAPu-SKANIDA/Test.php">
        <div class="form-group">
          <label>File input</label>
          <input type="date" id="file" data-provide="datepicker" name="file">
